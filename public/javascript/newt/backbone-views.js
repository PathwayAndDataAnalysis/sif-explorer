...
var PathsBetweenQueryView = Backbone.View.extend({
    ...
    render: function () {
        ...
        self.template = self.template(self.currentQueryParameters);
        $(self.el).html(self.template);
        console.log("on clicking pathsbetween backbone-views.js 2128");
        $(self.el).modal('show');
...
var PathsBetweenSIFgraphQueryView = Backbone.View.extend({
    ...
    initialize: function () {
        var self = this;
        self.copyProperties();
        self.template = _.template($('#query-pathsbetween-sifgraph-template').html());
        self.template = self.template(self.currentQueryParameters);
    },
    copyProperties: function () {
        this.currentQueryParameters = _.clone(this.defaultQueryParameters);
    ...
    render: function () {
        ...
        $(document)
            ...
            .on('click', '#save-query-pathsbetween-sifgraph', function (evt) {
                // use active chise instance
                var chiseInstance = appUtilities.getActiveChiseInstance();
                ...
                self.currentQueryParameters.directed = document.getElementById(
                    'query-pathsbetween-sifgraph-directed'
                ).value;
